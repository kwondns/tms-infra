...
resource "aws_secretsmanager_secret_version" "tms_secret_version" {
  ...
  secret_string = jsonencode({
    ...
    # elasticache_host          = aws_elasticache_replication_group.tms_valkey.primary_endpoint_address
    # elasticache_port          = aws_elasticache_replication_group.tms_valkey.port
    #
    #
